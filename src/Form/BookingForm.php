...
class BookingForm extends ContentEntityForm {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    if ($this->getOperation() == 'add') {
      ...
      $why_email = check_markup($bookingContent->get('koba_booking.why_email'), 'editor_format');
      $why_title = check_markup($bookingContent->get('koba_booking.why_title'), 'editor_format');
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    // Set message.
    $message_text = is_array($bookingContent->get('koba_booking.created_booking_message')) ? $bookingContent->get('koba_booking.created_booking_message')['value'] : $bookingContent->get('koba_booking.created_booking_message');
