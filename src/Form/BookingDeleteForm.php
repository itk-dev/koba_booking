...
/**
 * @file
 * Contains \Drupal\koba_booking\Form\BookingDeleteForm.
 */
...
/**
 * Provides a form for deleting a koba_booking entity.
 *
...
class BookingDeleteForm extends ContentEntityConfirmFormBase {
  ...
  public function getCancelURL() {
    return new Url('koba_booking.booking');
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    \Drupal::logger('koba_booking')->notice('@type: deleted %title.',
      array(
